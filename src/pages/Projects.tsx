      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="relative bg-gradient-to-br from-accent/20 to-primary/20 h-64 flex items-center justify-center">
                <Play className="h-16 w-16 text-primary hover:scale-110 transition-transform cursor-pointer" />
              </div>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-primary mb-2">Commercial Project Highlights</h3>
                <p className="text-muted-foreground">Behind-the-scenes look at our commercial construction expertise.</p>
              </CardContent>
            </Card>
          </div>
        </div>
